...
if (isset($_POST['submit'])) {
    try {
        ...
        $stmt = mysqli_prepare($conn, "UPDATE member_list 
            SET 
            Name = ?,
            Email = ?,
            Phone = ?,
        ...
        mysqli_stmt_bind_param($stmt, "sssssi", $Name, $Email, $Phone, $Age, $Organization, $id);
        ...
        if ($res) {
            //RECORD ACTIVITY LOG
            logActivity("Member Data of $Name updated!");
        ...
        $_SESSION['error_toast'] = "Error updating member: " . $e->getMessage();
        header('Location: list_view.php');
        exit;
