...
<head>
    ...
    <title>Organizations | CH-MGMT</title>
    ...
    <main class="dashboard d-flex">
        ...
        <div class="container-fluid background_main_white px-4">
            ...
            <div class="member-list-header d-flex justify-content-between align-items-center py-2">
                <div class="title h6 fw-bold">Church Organizations</div>
            ...
            <div class="table-responsive">
                ...
                <!-- TABLE CONTENT -->
                <table class="table organizations table-borderless">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <tr class="bg-white align-middle">
                                    ...
                                    <td class="d-md-flex gap-3 mt-3">
                                        <a href="update.php?Id=<?php echo $row['Id']; ?>" title="Edit Member"><i class="far fa-pen"></i></a>
                                        <a href="remove.php?Id=<?php echo $row['Id']; ?>" title="Remove Member" class="delete-member" data-id="<?php echo $row['Id']; ?>"><i class="far fa-trash"></i></a>
                                    </td>
                                </tr>
                                <?php
                            }
