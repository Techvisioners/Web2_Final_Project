...
function recordLog() {
    logActivity("Member List Report Generated");
}
recordLog();
...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(50, 10, 'PHONE', 1, 0, 'C', true);
        $this->Cell(15, 10, 'AGE', 1, 0, 'C', true);
        $this->Cell(40, 10, 'ORGANIZATION', 1, 1, 'C', true);
    }
...
try {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $pdf->Cell(40, 10, $row['Organization'], 1, 1, 'C');
        }
    ...
    $pdfFilename = 'chms_member_list_' . $fileDateFormat . '.pdf';
