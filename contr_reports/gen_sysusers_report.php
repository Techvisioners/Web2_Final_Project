...
function recordLog() {
    logActivity("List of Admin Accounts Report Generated");
}
recordLog();
...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(0, 1, 'CH-MS LIST OF SYSTEM ADMIN ACCOUNTS REPORT', 0, 1, 'C');
        ...
        $this->Cell(120, 10, 'ADMIN USERNAME', 1, 0, 'C', true);
        $this->Cell(130, 10, 'ADMIN EMAIL', 1, 1, 'C', true);
    }
...
try {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $pdf->Cell(120, 10, $row['Username'], 1, 0, 'C');
            $pdf->Cell(130, 10, $row['Email'], 1, 1, 'C');
        }
    ...
    $pdfFilename = 'chms_system_ausers_list_' . $fileDateFormat . '.pdf';
